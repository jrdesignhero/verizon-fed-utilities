...
var marqueeInserter = (function() {
  var marqueeString = {
      ...
      buildString: function() {
        ...
        marqueeString.currentString = inputString.value.trim().match(/\[marquee\][\s\S]*\[\/marquee\]/);
        ...
        logger.api.updateLogs(Date()+' - Marquee tags found: '+'Fail');
        logger.api.printLogs();
      },
      getString: function() {
        if (marqueeString.currentString !== null) {
          ...
          //log
          logger.api.updateLogs(Date()+' - Marquee Loader Output [ Error ]: Please enter html content between [marquee][/marquee] tags for each key<br /><br />');
          logger.api.printLogs();
      ...
      insertString: function() {
        ...
        if ( marqueeString.getString() ) {
          ...
          //log request
          logger.api.updateLogs(Date()+' - User generated HTML content keys inject into DOM<br /><br />');
        }
        logger.api.printLogs();
      }
    }
